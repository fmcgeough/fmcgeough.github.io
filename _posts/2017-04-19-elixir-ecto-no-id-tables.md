...
For anyone who stumbles upon this blog post I'd suggest you read the [Ecto Schema belongs_to](https://hexdocs.pm/ecto/Ecto.Schema.html#belongs_to) documentation. It
outlines what I described above.
