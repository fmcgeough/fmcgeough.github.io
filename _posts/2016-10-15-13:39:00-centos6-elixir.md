---
layout: post
title: 'Elixir/Ecto Installing to Centos 6'
categories:
- Elixir
tags: []
---
I finally got to the point where I've developed something that is actually useful for my company. Its
a standard web site done in Phoenix. The problem I wanted to solve was to create a browser of internal relational database structures for our product. Stuff that just isn't available through our UI but
