...
use DBConnection right after the declaration of the defmodule. This will invoke the __using__
...
So, its defining something called a [behavior](http://elixir-lang.org/getting-started/typespecs-and-behaviours.html#behaviours).
